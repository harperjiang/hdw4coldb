...
#include "SimdBuffer64.h"
#include "SimdHelper.h"

__m256i SimdBuffer64::EMPTY = _mm256_setzero_si256();

namespace SimdBuffer64Constants {
...
using namespace SimdBuffer64Constants;

__m256i SimdBuffer64::align(__m256i input, int *inputSize) {
...
__m256i SimdBuffer64::merge(__m256i a, __m256i b, int asize) {
	return BLEND64[asize](a, b);
}

__m256i SimdBuffer64::shl(__m256i a, int offset) {
	return SHL64[offset](a);
}

__m256i SimdBuffer64::shr(__m256i a, int offset) {
	return SHR64[offset](a);
}

SimdBuffer64::SimdBuffer64() {
	buffer = EMPTY;
	bufferSize = 0;
}
...
__m256i SimdBuffer64::serve(__m256i input, int *outputSize) {
	int inputSize;
...
__m256i SimdBuffer64::purge(int *outputSize) {
